...
% empty contatiner defining the strcuture and kinematics of the robot
robot = rigidBodyTree; 
...
tform = getTransform(robot,randConfig,"body6","body1");
showdetails(robot)
...
[configSoln,solnInfo] = ik("body6",user_tform,weights,initialguess);
